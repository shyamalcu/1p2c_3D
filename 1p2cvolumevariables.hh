...
public:
                ...
                const bool isOldSol)
    {
        ...
        density_ = problem.spatialParams().density();
        viscosity_ = problem.spatialParams().density();
        if (tortuosity_ > 0)
        {
        ...
        dispersivity_ = 0;
        dispersivity_[0] = problem.spatialParams().dispersivity(element, fvGeometry, scvIdx);
//        dispersivity_[0] = 1;
        dispersivity_[1] = 0.1;
                                   ...
                                   FluidState& fluidState)
    {
        ...
        Scalar value;
        value = problem.spatialParams().density();
//        value = FluidSystem::density(fluidState, paramCache, phaseIdx);
        fluidState.setDensity(phaseIdx, value);
        value = problem.spatialParams().viscosity();
//        value = FluidSystem::viscosity(fluidState, paramCache, phaseIdx);
    ...
    {
//    	return density_; //return constant
    ...
    {
    	return fluidState_.density(phaseIdx) * fluidState_.massFraction(phaseIdx, (compIdx==0)?phaseCompIdx:transportCompIdx); // *  porosity_ ;
    }
